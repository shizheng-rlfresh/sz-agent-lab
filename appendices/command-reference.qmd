...
| `quarto render` fails on citation | reference discipline | inspect `references.bib` keys and chapter citation syntax |
| `quarto render` fails on structure | manuscript syntax | inspect the first failing `.qmd` and nearby fenced blocks or headings |
